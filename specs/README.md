...
| ID | Producto | Estado |
| --- | --- | --- |
| [001-vaca-muerta-pulse](001-vaca-muerta-pulse/spec.md) | **Barrilito** (repo `vaca-muerta-pulse`) — Cap. IV, simulación mensual | Activa · Hito 2 (dbt; `dbt build` BQ pide `GCP_SA_KEY_DBT`) |
